...
{
    /**
     * Delegates list based on pagination & limit.
     */
    public $data = [];
    ...
    private function fetch($page, $limit)
    {
        ...
        $apiUrl = SelectedNetwork::getUrl().'/delegates?'.http_build_query($queryParams);
    ...
    {
        return redirect()->to('/delegates/1');
    }
    ...
    {
        return redirect()->to('/delegates/'.$page);
    }
